	...
	<div class='goodsWrapper'>
		<div class='goods'>
			<div class='menu-wrapper' ref='menuWrapper' >
				<ul>
					<li v-for='(item,index) in goods' :key = 'item.index' class='menu-item' :class="{'current':currentIndex === index}" @click='scrollToElement(index,$event)'>
