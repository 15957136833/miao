<template>
	<div class= 'ratings' ref='ratings'>
		<div>
				...
				<div class='overview'>
					...
					<div class='overview-right'>
						...
						<div class='score-wrapper'>
							...
							<star class='' :size='36' :score='seller.foodScore'></star>
			...
			<split></split>
			<ratingselect @selectProp='selectProp' @contentToggle='contentToggle' :select-type='selectType' :only-content='onlyContent' :ratings='ratings'></ratingselect>
